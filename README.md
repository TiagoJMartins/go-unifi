...
[![Docs](https://img.shields.io/badge/docs-reference-blue)](https://github.com/paultyng/go-unifi/blob/main/docs/readme.md)
[![GoDoc](https://godoc.org/github.com/paultyng/go-unifi?status.svg)](https://godoc.org/github.com/paultyng/go-unifi)
...
List of available client configuration options is available [here](https://pkg.go.dev/github.com/paultyng/go-unifi/unifi#ClientConfig).
...
To use interceptor logic, you need to create a struct implementing [ClientInterceptor](https://pkg.go.dev/github.com/paultyng/go-unifi/unifi#ClientInterceptor) interface.
